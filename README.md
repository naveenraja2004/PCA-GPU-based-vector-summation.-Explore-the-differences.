...
i) block.x=1023
```
Name : naveenraja nr  Register No : 212222230093 #include "../common/common.h" #include <cuda_runtime.h> #include <stdio.h>
...
```
```
Name : NAVEEN RAJA NR Register No : 212222230093 #include "../common/common.h" #include <cuda_runtime.h> #include <stdio.h>
...
## Output:
block.x = 1023:
![pca exp 1](https://github.com/naveenraja2004/PCA-GPU-based-vector-summation.-Explore-the-differences./assets/118707204/6c8439f0-02de-4344-86c9-5baece236871)
block.x = 1024:
![pc exp 2](https://github.com/naveenraja2004/PCA-GPU-based-vector-summation.-Explore-the-differences./assets/118707204/88d09be0-7211-4d53-b32d-2fa572bab204)
block.x = 256:
![pca exp 3](https://github.com/naveenraja2004/PCA-GPU-based-vector-summation.-Explore-the-differences./assets/118707204/11e6d12e-f3cb-4207-8db7-25d08da8ada0)
